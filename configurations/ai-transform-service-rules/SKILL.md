---
name: ai-transform-service-rules
description: Apply global coding rules plus AI Transform Service project-specific rules. Use when working on CDS, IPAFFS, QC, QC3PL, RAG, parser/extractor providers, prompts, dataset routes, or related PR workflows.
---
