---
name: teach-explain
description: Teach code to junior developers with big-picture explanation, syntax deep dive, code context, system design, annotated code, and learning checkpoints.
---
