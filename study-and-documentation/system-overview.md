---
name: sys-overview
description: Analyze the repository at the current working directory and produce a comprehensive 'system-overview.md' file. Follow the exact structure, formatting conventions, and depth shown below. Do not omit sections. Use concise, factual technical writing.
---
