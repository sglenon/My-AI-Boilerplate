---
name: spec-driven-tasks-to-issues
description: "Convert existing tasks into actionable, dependency-ordered GitHub issues for the feature based on available design artifacts. Use when the user invokes $spec-driven-tasks-to-issues or requests the tasks-to-issues phase of a spec-driven workflow."
---
