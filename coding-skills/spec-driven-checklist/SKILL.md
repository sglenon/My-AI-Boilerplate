---
name: spec-driven-checklist
description: "Generate a custom checklist for the current feature based on user requirements. Use when the user invokes $spec-driven-checklist or requests the checklist phase of a spec-driven workflow."
---
...
- `checklists/requirements.md` is a separate built-in spec-quality checklist maintained by `$spec-driven-specify` and `$spec-driven-clarify`; do not treat that exception as applying to custom checklists generated here.
...
**Important**: Each `$spec-driven-checklist` command invocation uses a short, descriptive checklist filename and either creates a new file or appends to an existing one. This allows:
